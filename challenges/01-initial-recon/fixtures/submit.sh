#!/bin/sh
# Source this file to define `submit`:
#   source /opt/ctf/fixtures/submit.sh
#   submit 'FALCO{...}'            # ← (evade challenges only)
#
# Display names are operator-managed and pre-seeded into the scoreboard
# at workspace deploy time. There is no participant-side setter.
