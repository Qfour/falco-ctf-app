...
| [0010](0010-issue118-flag-env-leak-closure-and-i12-promotion.md) | Issue #118 (H1) の閉止確認 + I12 昇格 | **Proposed** | H1 (全ミッション CTF_FLAG_* の challenge コンテナ env 漏えい) は main で ADR-0001(Option B)+ADR-0007(Option 1) により既に遮断済みと実測確認。新規設計は行わず、I12 (フラグ隔離) を Hard Invariant へ昇格・Issue #118 クローズを提案 | — |
