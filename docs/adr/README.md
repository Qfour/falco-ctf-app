...
| **0005** | (未 merge・番号予約済み) | Proposed (draft PR) | OpenAPI spec 正典化 + parity gate。`docs/api-spec-canon` (#143) / `feat/api-spec-parity-gate` (#149) の draft PR 上にのみ存在。main には未 landing (2026-08-21 実測) | — |
